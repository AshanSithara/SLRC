...
/*    @Size(min = 5, message = "Enter Programme Name ")
    ...
    public Programme( @Size(min = 5, message = "Enter Programme Name ") String programmeName, @Size(min = 5, message = "Enter Producer Name ") String producerName, @Size(min = 5, message = "Enter Sponsor Name ") String sponsorName, LocalDate broadcastingDate, String broadcastingTime, String code) {
